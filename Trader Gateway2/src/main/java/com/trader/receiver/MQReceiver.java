...
public class MQReceiver {
    ...
    @JmsListener(destination = "OrderBlotters2")
    public void listenBlotter2(String msg) throws JMSException {
        ...
        orderHandler.setOrderBlotters2(orderBlotters);
    }
    @JmsListener(destination = "OrderBlotters4")
    public void listenBlotter4(String msg) throws JMSException {
        OrderBlotters orderBlotters = JSONObject.parseObject(msg, OrderBlotters.class);
        //log.info(orderBlotters.toString());
        orderHandler.setOrderBlotters4(orderBlotters);
    }
    ...
    @JmsListener(destination = "MyOrder2")
